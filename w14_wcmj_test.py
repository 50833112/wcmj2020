...
try:
    ...
    body = {
    "kind": "blogger#post",
    "id": "5595738221106367345",
    "title": "透過 Python 程式新增網誌文章",
    "content":"使用 Google Blogger API 可以利用程式新增網誌文章內容"
    }
    insert = posts.insert(blogId='5595738221106367345', body=body)
    ...
    update = posts.update(blogId="5595738221106367345", postId="1389587938059038064", body=body, publish=True)
